module Mittsu
  class Box3
    ...
    def initialize
      @min = Mittsu::Vector3.new(Float64::INFINITY, Float64::INFINITY, Float64::INFINITY)
      @max = Mittsu::Vector3.new(-Float64::INFINITY, -Float64::INFINITY, -Float64::INFINITY)
    end
    ...
    def make_empty
      @min.x = @min.y = @min.z = Float64::INFINITY
      @max.x = @max.y = @max.z = -Float64::INFINITY
      self
    end
